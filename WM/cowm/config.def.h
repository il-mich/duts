...
static const char *fonts[]    = { "Overpass Mono:style=Bold:size=11:antialias=true:autohint=false" };
static const char dmenufont[] = "Overpass Mono:style=Bold:size=11:antialias=true:autohint=false";
